...
def get_verse():
    ...
    if split == 0:
        ...
        if row:
            for i in (row):
                # print(row[i][1])
                lyrics += f"<p id={i[4]} style='border: 1px solid black;padding: 10px;'>"+ "<span style='font-weight:bold;font-size:larger;'>" + result_list[selected_id][3] + ":" + str(i[4]) + "</span><br>" +i[1]+ "</p>"
    ...
    if split == 2:
        ...
        if row:
            for i in range(len(row)):
                # print(row[i][1])
                lyrics += f"<p id={row[i][4]} style='border: 1px solid black;padding: 10px;'>"+ "<span style='font-weight:bold;font-size:larger;'>" + result_list[selected_id][3] + ":" + str(row[i][4]) + "</span><br>" +row[i][1]+ "</p>" + f"<p id={row[i][4]} style='border: 1px solid black;padding: 10px;'>"+ "<span style='font-weight:bold;font-size:larger;'>" + result_list[selected_id][3] + ":" + str(row[i][4]) + "</span><br>" + f"<span style='color:green;'>{row1[i][1]}</span></p>"
